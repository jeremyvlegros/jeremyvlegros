...
date_of_modification : "#date 2023-08-03 03:09 1691017756157436353 GMT"
...
I want a job where I can thrive, I won't search for it anymore, I'll just invent it.
...
The conclusion I retain from this is the same I had before, with an added third part :
    ...
    I want a fair job, with a fair description, testing my skills fairly, I don't have enough sanity to deal with humans not able to propose that

N.B : In the following years the government didn't renew contracts for qualified technicians, there were protests, instead, people without computer science background were hired.
